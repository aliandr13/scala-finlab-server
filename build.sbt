organization := "com.github.aliandr13"
name         := "scala-finlab-server"
...
git.remoteRepo := "git@github.com:aliandr13/scala-finlab-server.git"

micrositeGithubOwner := "aliandr13"

micrositeGithubRepo := "scala-finlab-server"

micrositeName := "Scala Finlab Server"

micrositeDescription := "An example application using FP techniques in Scala"

micrositeBaseUrl := "scala-finlab-server"
